              ...
              <Col span={12}>
                <Form.Item name="aadharUrl">
                  <PdfUploader
                    ...
                    initialFiles={
                      formData.aadharUrl ? [formData.aadharUrl] : []
                    }
                  />
                </Form.Item>
              </Col>
              ...
              <Col span={12}>
                <Form.Item name="shopImageUrl">
                  <PdfUploader
                    ...
                    initialFiles={
                      formData.shopImageUrl ? [formData.shopImageUrl] : []
                    }
                  />
                </Form.Item>
              </Col>
        ...
        <div style={{ marginTop: 24 }}>
          {formData && (
            <>
              ...
              {["Pending", "Reject"].includes(formData.status) &&
                current === steps.length - 1 && (
                  <>
                    <Button
                      type="primary"
